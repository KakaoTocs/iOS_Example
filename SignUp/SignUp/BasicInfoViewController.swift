...
class BasicInfoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var selfIntroBox: UITextField!
...
//            detailInfoViewController.modalTransitionStyle = .crossDissolve
            self.present(detailInfoViewController, animated: true, completion: nil)
        }
    }
